...
cdf <- read.csv('../outputs/asv1_v3combined_outputs_comm1_50_spp50.csv', stringsAsFactors = FALSE)

```

We have the results for fifty communities. These are the differences in the code compared to last round of results:
