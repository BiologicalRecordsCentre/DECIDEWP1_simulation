...
ggplot() +
  xlab('PC1') + ylab('PC2') +
  geom_path(data = subset(dfmeth$ellip_dat, groups != 'true'), 
            aes(x = xvar, y = yvar, col = groups, group = groups)) +
  geom_path(data = subset(dfmeth$ellip_dat, groups == 'true'), 
            aes(x = xvar, y = yvar, col = 'truth', group = groups), linetype = 'dashed', width = 2)
